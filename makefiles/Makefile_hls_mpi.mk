...
HLS_LDFLAGS= -lxilinxopencl -lmpi -lops_mpi -lops_hls_mpi -lpthread -lrt -lstdc++ -L$(XILINX_XRT)/lib/ -L$(OPS_INSTALL_PATH)/hls/lib/$(OPS_COMPILER)/ -Wl,-rpath-link,$(XILINX_XRT)/lib 
