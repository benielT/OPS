...
// #endif
        ...
        std::cout << std::endl << "[DEBUG] **** Generating Tile Metadata ****" << std::endl;
        ...
        dut(mem_in_b, mem_in_b, mem_out_b, mem_out_b, dim, gridSize_copy[0], gridSize_copy[1], gridSize_copy[2],
            range_copy.start[0], range_copy.end[0], range_copy.start[1], range_copy.end[1], range_copy.start[2], range_copy.end[2],
            tile_size_copy[0], tile_size_copy[1], 
