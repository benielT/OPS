        ...
        if [[ "${CXXFLAGS}" == *"-DBATCHING"* ]]; then
            if [[ "${PLATFORM}" == *"u280"* ]]; then
                parameter_sets=(
                    ...
                    "30,30,60120,100,20"
                    "60,60,60120,100,20"
                    "100,100,60120,100,20"
                    "200,100,60120,100,20"
                    "200,200,60120,100,20"
                    "300,150,60120,100,20"
                    "300,300,60120,20,20"
                    "400,200,60120,20,20"
                    "400,300,60120,20,20"
                    "400,400,60120,20,20"
                    ...
                    "300,300,60120,100,100"
                    "400,200,60120,100,100"
                    "400,300,60120,100,100"
                    "400,400,60120,100,100"
                    # Add more parameter sets here as needed
                    )
            else
                parameter_sets=(
