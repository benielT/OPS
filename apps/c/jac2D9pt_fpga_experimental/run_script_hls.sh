        ...
        if [[ "${CXXFLAGS}" == *"-DBATCHING"* ]]; then
            if [[ "${PLATFORM}" == *"u280"* ]]; then
                parameter_sets=(
                    ...
                    "400,300,60018,500,1"
                    "400,400,60018,500,1"
                    "60,60,60018,10000,10"
                    "30,30,60018,10000,10"
                    "100,100,60018,5000,10"
                    # "200,100,60018,5000,10"
                    # "200,200,60018,5000,10"
                    # "300,150,60018,2500,10"
                    # "300,300,60018,1000,10"
                    # "400,200,60018,500,10"
                    # "400,300,60018,500,10"
                    # "400,400,60018,500,10"
                    "30,30,60018,10000,20"
                    "60,60,60018,10000,20"
                    # "100,100,60018,5000,20"
                    # "200,100,60018,5000,20"
                    # "200,200,60018,5000,20"
                    # "300,150,60018,2500,20"
                    # "300,300,60018,1000,20"
                    # "400,200,60018,500,20"
                    # "400,300,60018,500,20"
                    # "400,400,60018,500,20"
                    "30,30,60018,10000,50"
                    # "60,60,60018,10000,50"
                    # "100,100,60018,5000,50"
                    # "200,100,60018,5000,50"
                    # "200,200,60018,5000,50"
                    # "300,150,60018,2500,50"
                    # "300,300,60018,1000,50"
                    # "400,200,60018,500,50"
                    # "400,300,60018,500,50"
                    # "400,400,60018,500,50"
                    # "100,100,60018,5000,100"
                    # "200,100,60018,5000,100"
                    # "200,200,60018,5000,100"
                    # "300,150,60018,2500,100"
                    # "300,300,60018,1000,100"
                    # "400,200,60018,500,100"
                    # "400,300,60018,500,100"
                    # "400,400,60018,500,100"
