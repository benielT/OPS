// Auto-generated at 2026-01-27 16:58:13.523767 by ops-translator
...
/*
    ArgDat(id=0, loc=/home/x_thileeb/repos/ops-hls-batching-tiling-artifacts/codegen_apps/tiling/jacobian3d/u280_project/jac3D7pt.cpp/322:21, access_type=AccessType.OPS_READ, opt=True, dat_id=0, global_dat_id=-1, stencil_id=S3D_7PT)
    ArgDat(id=1, loc=/home/x_thileeb/repos/ops-hls-batching-tiling-artifacts/codegen_apps/tiling/jacobian3d/u280_project/jac3D7pt.cpp/323:21, access_type=AccessType.OPS_WRITE, opt=True, dat_id=1, global_dat_id=-1, stencil_id=S3D_00)
*/
...
public:
        ...
        )
    {
        ...
        const unsigned short adj_half_span_x = half_span_x * (peId + 1);

        // static limits are set outside the tile loops
        const unsigned short lower_limit_x = adj_half_span_x;
        const unsigned short upper_limit_x_const = (stencilConfig.last_tile_upper_limit_x - adj_half_span_x) < adj_half_span_x ? adj_half_span_x : (stencilConfig.last_tile_upper_limit_x - adj_half_span_x);
        const unsigned short lower_limit_y = adj_half_span_x;
        const unsigned short lower_limit_z = half_span_x;
        const unsigned short upper_limit_y_const = (stencilConfig.last_tile_size[1] - adj_half_span_x) < adj_half_span_x ? adj_half_span_x : (stencilConfig.last_tile_size[1] - adj_half_span_x);
        ...
        // {
            ...
            tile_x = tile_id_reged % stencilConfig.tile_count[1];
        ...
        //  *** iteration limit definition ****
            unsigned int iter_limit = stencilConfig.outer_loop_limit * tile_size_x * tile_size_y;

        //  *** data read write boundary definitions ****
            unsigned int S3D_7PT_read_lb_itr = 0;
            unsigned int S3D_7PT_read_ub_itr = stencilConfig.grid_size[2] * tile_size_x * tile_size_y;
